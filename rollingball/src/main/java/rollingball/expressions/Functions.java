...
public final class Functions {
    ...
    public static Expr parseFunctionCall(String name, Expr firstParam, Supplier<Expr> paramSupplier) {
        return switch (name.toLowerCase()) {
            ...
            case "asin", "arcsin" -> ctx -> Math.asin(firstParam.evaluate(ctx));
            case "acos", "arccos" -> ctx -> Math.acos(firstParam.evaluate(ctx));
            case "atan", "arctan" -> ctx -> Math.atan(firstParam.evaluate(ctx));
            ...
            case "log", "ln" -> ctx -> Math.log(firstParam.evaluate(ctx));
            case "log10", "lg" -> ctx -> Math.log10(firstParam.evaluate(ctx));
